...
$ORACLE_HOME/bin/adrci exec="set base /home/oracle; show homes"| grep -v : | while read LINE
do
        echo "INF: purging home $LINE"
        sleep 5
        echo " purging ALERT"
        $ORACLE_HOME/bin/adrci exec="set base /home/oracle; set homepath $LINE;purge -age ${PURGE_TIME} -type ALERT"
        echo " purging INCIDENT"
        $ORACLE_HOME/bin/adrci exec="set base /home/oracle; set homepath $LINE;purge -age ${PURGE_TIME} -type INCIDENT"
        echo " purging TRACE"
        $ORACLE_HOME/bin/adrci exec="set base /home/oracle; set homepath $LINE;purge -age ${PURGE_TIME} -type TRACE"
        echo " purging CDUMP"
        $ORACLE_HOME/bin/adrci exec="set base /home/oracle; set homepath $LINE;purge -age ${PURGE_TIME} -type CDUMP"
        echo " purging HM"
        $ORACLE_HOME/bin/adrci exec="set base /home/oracle; set homepath $LINE;purge -age ${PURGE_TIME} -type HM"
        echo " rotating LOG"

        echo ""
done

$ORACLE_HOME/bin/adrci exec="set base /u01/grid/11204/log; show homes"| grep -v : | while read LINE
do
        echo "INF: purging home $LINE"
        sleep 5
        echo " purging ALERT"
        $ORACLE_HOME/bin/adrci exec="set base /u01/grid/11204/log; set homepath $LINE;purge -age ${PURGE_TIME} -type ALERT"
        echo " purging INCIDENT"
        $ORACLE_HOME/bin/adrci exec="set base /u01/grid/11204/log; set homepath $LINE;purge -age ${PURGE_TIME} -type INCIDENT"
        echo " purging TRACE"
        $ORACLE_HOME/bin/adrci exec="set base /u01/grid/11204/log; set homepath $LINE;purge -age ${PURGE_TIME} -type TRACE"
        echo " purging CDUMP"
        $ORACLE_HOME/bin/adrci exec="set base /u01/grid/11204/log; set homepath $LINE;purge -age ${PURGE_TIME} -type CDUMP"
        echo " purging HM"
        $ORACLE_HOME/bin/adrci exec="set base /u01/grid/11204/log; set homepath $LINE;purge -age ${PURGE_TIME} -type HM"
        echo " rotating LOG"
        echo ""
done
